...
<body>
	<nav id="content-header"> <B>位置：</B>人证相符
	<div class="return">
						...
						<c:forEach var="ins" items="${results}" varStatus="vs">
							<tr class="bggray"
								...
								<td align="center" valign="middle" width="100"
									...
									href="javascript:location.href=encodeURI('<%=path%>/people?method=showSiteMain&pno=${ins.pno}&projectName=${ins.projectName}')">${ins.projectName}</a>
								</td>
								<td align="center" valign="middle" width="100"
