...
<body>
	<nav id="content-header"> <B>位置：</B>基坑监测
	<div class="return">
		...
		<div class="row" style="margin: 0px;">
			<div class="col-md-12">
				<form method="post" action="#">
					<div class="row">
						<div class="col-sm-4">
							<label class="form_query">工程名称&nbsp;:&nbsp;</label><input
								type="text" name="qoprojectName" />
						</div>
						<div class="col-sm-4">
							<label class="form_query">工程地址&nbsp;:&nbsp;</label><input
								type="text" name="qolocation" />
						</div>
						<div class="col-sm-4"></div>
					</div>
					<div class="row">
						<div class="col-sm-4">
							<label class="form_query">建设单位&nbsp;:&nbsp;</label><input
								type="text" name="qoinvestor" />
						</div>
						<div class="col-sm-4">
							<label class="form_query">施工单位&nbsp;:&nbsp;</label><input
								type="text" name="qobuilder" />
						</div>
						<div class="col-sm-4">
						...
						<c:forEach var="ins" items="${results}" varStatus="vs">
							<tr class="bggray"
								...
								<td align="center" valign="middle" width="100"
									...
									href="javascript:location.href=encodeURI('<%=path%>/pitbase?method=showSiteMain&pno=${ins.pno}&projectName=${ins.projectName}')">${ins.projectName}</a>
								</td>
								<td align="center" valign="middle" width="100"
