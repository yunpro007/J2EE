...
<body>
	<nav id="content-header"> <B>位置：</B>门禁考勤
	<div class="return">
	...
	<div class="header-query">
		<div class="row" style="margin: 0px;">
			<div class="col-md-12">
				<form method="post"
					action="<%=path%>/environment?method=queryByCondition&projectNum=${projectNum}&projectName=${projectName}">
					<div class="row">
						<div class="col-sm-4">
						...
						<c:forEach var="ins" items="${results}" varStatus="vs">
							<tr class="bggray"
								...
								<td align="center" valign="middle" width="100"
									class="borderright borderbottom"><a href="javascript:location.href=encodeURI('<%=path%>/door?method=listDoorForProject&projectNum=${ins.projectNum}&projectName=${ins.projectName}')">${ins.projectName}</a>
								</td>
								<td align="center" valign="middle" width="100"
