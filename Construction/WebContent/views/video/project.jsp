...
<body>
	<nav id="content-header"> <B>位置：</B>工地视频
	<div class="return">
						...
						<c:forEach var="ins" items="${results}" varStatus="vs">
							<tr class="bggray"
								...
								<td align="center" valign="middle" width="100"
									class="borderright borderbottom"><a href="javascript:location.href=encodeURI('<%=path%>/video?method=listVideoForProject&projectNum=${ins.projectNum}&projectName=${ins.projectName}')">${ins.projectName}</a>
								</td>
								<td align="center" valign="middle" width="100"
